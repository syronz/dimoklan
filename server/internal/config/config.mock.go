...
func SetCoreForTest() (core Core, err error) {
	core.config = config{
		...
		BasicMasterDatabaseDSN: "root:root@tcp(127.001:3306)/dimo_basic",
		BasicSlaveDatabaseDSN:  "root:root@tcp(127.001:3306)/dimo_basic",
		ActivityDatabaseDSN:    "root:root@tcp(127.001:3306)/dimo_activity",
